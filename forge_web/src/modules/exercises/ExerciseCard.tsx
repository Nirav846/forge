/**
 * Exercise Card Component - Ultra Compact with Smart Modal
 * Displays individual exercise with minimal footprint, full details in modal
 */
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <span className="px-2 py-1 bg-blue-100 text-blue-700 rounded font-medium">{exercise.movement_pattern}</span>
                  <span className="px-2 py-1 bg-purple-100 text-purple-700 rounded font-medium">{exercise.equipment}</span>
                  <span className="px-2 py-1 bg-gray-100 text-gray-700 rounded">{exercise.category}</span>
                </div>
              </div>
              <button
                onClick={onClose}
...
export const ExerciseCard: React.FC<ExerciseCardProps> = ({ exercise, onClick }) => {
  ...
  return (
    <>
      <div 
        className="bg-white rounded-lg shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-200 cursor-pointer border border-gray-200 overflow-hidden group"
      ...
      >
        ...
        <div className="px-3 py-1.5 bg-white">
          <div className="flex items-center gap-1.5 text-[10px]">
            ...
            <span className="px-1.5 py-0.5 bg-purple-50 text-purple-700 rounded truncate max-w-[70px]" title={exercise.equipment}>
              {exercise.equipment}
            </span>
          </div>
        </div>
        ...
        {/* Hover Hint */}
        <div className="px-3 py-1.5 bg-gray-50 border-t border-gray-100 opacity-0 group-hover:opacity-100 transition-opacity">
