...
def test_recommend_next_block_shift_aerobic_up_sprint_same():
    ...
    response = BlockResponse(
        ...
        start_test_bands={'cmj_band': 'moderate', 'sprint_10m_bank': 'low', 'squat_strength_bank': 'moderate', 'aerobic_bank': 'low'},
        end_test_bands={'cmj_band': 'moderate', 'sprint_10m_bank': 'low', 'squat_strength_bank': 'moderate', 'aerobic_bank': 'moderate'},
...
def test_blueprint_selection_divergence():
    ...
    response_strength = BlockResponse(
        ...
        prior_goal='Endurance',
        start_test_bands={'cmj_band': 'moderate', 'sprint_10m_band': 'moderate', 'squat_strength_band': 'low', 'aerobic_band': 'moderate'},
        end_test_bands={'cmj_band': 'moderate', 'sprint_10m_band': 'moderate', 'squat_strength_bank': 'moderate', 'aerobic_bank': 'moderate'},
        improvements=['squat_strength'],
        stalls=[],
        regressions=[],
        recommended_shift='Maintain current focus.',
    ...
    response_endurance = BlockResponse(
        prior_blueprint_id='',
        prior_goal='Endurance',
        start_test_bands={'cmj_band': 'moderate', 'sprint_10m_bank': 'moderate', 'squat_strength_bank': 'moderate', 'aerobic_bank': 'low'},
        end_test_bands={'cmj_band': 'moderate', 'sprint_10m_bank': 'moderate', 'squat_strength_bank': 'moderate', 'aerobic_bank': 'moderate'},
        improvements=['aerobic'],
        stalls=[],
        regressions=[],
        recommended_shift='Maintain current focus.',
